...
def test_score_event():
    event1 = Event(name="Event 1", cost=25.0, duration=2, base_exp=100.0, opening_hours=None)
    score = score_event(event1, actual_duration=1, w_xp=1.0, w_count=1.0, w_cost=-1.0, w_dur=-1.0)
